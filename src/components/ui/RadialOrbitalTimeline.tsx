...
export function RadialOrbitalTimeline({
  ...
  const getStatusStyles = (status: TimelineItem['status']): string => {
    switch (status) {
      case 'completed':
        return 'text-white bg-astra-violet border-astra-violet';
      case 'in-progress':
    ...
    <div
      ...
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        <div
          ...
          {/* Central Core */}
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-astra-violet via-astra-blue to-cyan-500 animate-pulse flex items-center justify-center z-10">
              ...
              <div
                ...
                <div
                  className={`
                    ...
                    ${isExpanded ? 'bg-astra-violet text-white' : isRelated ? 'bg-astra-violet/50 text-white' : 'bg-black text-white'}
                    border-2 
                    ${isExpanded ? 'border-astra-violet shadow-lg shadow-astra-violet/30' : isRelated ? 'border-astra-violet animate-pulse' : 'border-white/40'}
                ...
                {/* Expanded Card */}
                {isExpanded &&
                <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-astra-violet/10 overflow-visible">
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div
                          className="h-full bg-gradient-to-r from-astra-blue to-astra-violet"
                          style={{
                            width: `${item.energy}%`
                          }} />
